...
export default function PortfolioPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="w-20 h-20 mx-auto mb-4 animate-float-wobble">
            <img
              src="/logo.jpeg"
              alt="Fuggler Cat"
              className="w-full h-full object-contain drop-shadow-[0_0_15px_rgba(233,30,140,0.6)]"
            />
          </div>
          <p className="text-neon-pink font-bold text-lg animate-glitch">載入中...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header */}
      <header className="glass-dark shadow-neon-pink border-b-2 border-fuggler-pink sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 animate-float-wobble hover:animate-creepy-shake-infinite transition-all cursor-pointer">
                <img
                  src="/logo.jpeg"
                  alt="Fuggler Cat"
                  className="w-full h-full object-contain drop-shadow-[0_0_10px_rgba(233,30,140,0.8)]"
                />
              </div>
              <div>
                <h1 className="text-xl font-creepy text-gradient-fuggler tracking-wider">巴菲羽的小金庫</h1>
                <p className="text-xs text-fuggler-pink hidden sm:block">👁 怪物理財小幫手 👁</p>
              </div>
            </div>
            <ProfileSelector
              profiles={profiles}
      ...
      {/* Footer */}
      <footer className="glass-dark border-t-2 border-fuggler-pink mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <p className="text-center text-sm text-fuggler-pink">
            ⚠️ 本工具僅供參考，不構成任何投資建議。投資有風險，決策請謹慎... 🦷
          </p>
        </div>
      </footer>
